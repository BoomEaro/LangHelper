...
public class Translate1_21_R3 extends JsonTranslateManager {

    public Translate1_21_R3(Plugin plugin, ConfigManager configManager) {
        super("1.21.4", plugin, configManager);
    }
