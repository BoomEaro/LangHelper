...
public class Translate1_21_R7 extends JsonTranslateManager {

    public Translate1_21_R7(Plugin plugin, ConfigManager configManager) {
        super("1.21.11", plugin, configManager);
    }
