...
public class Translate1_21_R4 extends JsonTranslateManager {

    public Translate1_21_R4(Plugin plugin, ConfigManager configManager) {
        super("1.21.5", plugin, configManager);
    }
