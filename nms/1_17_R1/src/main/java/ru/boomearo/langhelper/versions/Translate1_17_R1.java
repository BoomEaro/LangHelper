...
public class Translate1_17_R1 extends JsonTranslateManager {

    public Translate1_17_R1(Plugin plugin, ConfigManager configManager) {
        super("1.17.1", plugin, configManager);
    }
