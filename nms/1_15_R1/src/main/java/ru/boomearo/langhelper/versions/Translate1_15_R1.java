...
public class Translate1_15_R1 extends JsonTranslateManager {

    public Translate1_15_R1(Plugin plugin, ConfigManager configManager) {
        super("1.15.2", plugin, configManager);
    }
